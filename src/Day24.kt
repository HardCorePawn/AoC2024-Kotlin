...
//    val input = readInput("Day24_test")
    ...
    fun processGates(toProcess: List<Gate>) {
        ...
        while (i in 0..<sortedX.size / 2) {
            if (i == 0) {
                ...
                if (xorCheck.type != GateType.XOR) {
                    ...
                    println("Bad wires at $bitPair - $nameZ is not on XOR gate")
                    ...
                    println("Bad wires at $bitPair - x XOR y gate output is wrong")
                    val badGate =
