fun main() {
    ...
    fun initComputer(input: List<String>): Computer {

        val computer = Computer()

        // set registers
        computer.a = input[0].substringAfter("Register A: ").toLong()
        computer.b = input[1].substringAfter("Register B: ").toLong()
        computer.c = input[2].substringAfter("Register C: ").toLong()

        // extract program listing
        computer.program = input[4].substringAfter("Program: ").split(",").map { it.toInt() }
    ...
    fun part1(input: List<String>) {
        ...
        val computer = initComputer(input)
    ...
    fun check(regA: Long, program: List<Int>, outs: List<Int>, computer: Computer): Boolean {
        computer.a = regA
        var iptr = 0
        var outpos = 0
    ...
    fun part2(input: List<String>): Long {
        ...
        return reverseEngineer(0L, 1, computer.program, targetOutput, computer)
    }

    // Read the input from the `src/Day17_input.txt` file.
//    val input = readInput("Day17_sample")
